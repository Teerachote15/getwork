    ...
    return Scaffold(
      ...
      body: Column(
        children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: _HeaderMenuItem('โพสรออนุมัติ', selected: true),
                      ),
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(builder: (_) => const PaymentPage(origin: 'posts')),
                          );
                        },
          ...
          Text(
            'แก้เป็นปุ่มเปล่าๆและเพิ่มหัวข้อ',
            style: TextStyle(
              color: Color(0xFF22577A),
              fontSize: 16,
            ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          _TableHeaderCell('ข้อมูลโพส', flex: 2),
                          // ลบหัวคอลัมน์ "อนุมัติ/ไม่อนุมัติ"
                          ...
                          return Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                // ข้อมูลโพส (เฉพาะปุ่ม ตรวจสอบข้อมูล ตรงกลาง)
                                Expanded(
                                  flex: 2,
                                  child: Center(
                                ...
                                // ปุ่ม อนุมัติ/ไม่อนุมัติ (ไม่มีหัวคอลัมน์)
                                Expanded(
                                  flex: 2,
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
